...
## Proporcão de votos válidos do Haddad

```{r}
Prediction[nrow(Prediction),]
```

Até é possível calcular a probabilidade de vitória do Haddad, mas por ser tão baixa prefiro nem olhar. (O Neale tá estimando 2%)
